...
rule mv_cstacks:
    ...
    output:
        tags_cstacks="results/lib2/stacks_denovo/cstacks/catalog.tags.tsv.gz",
        snps_cstacks="results/lib2/stacks_denovo/cstacks/catalog.snps.tsv.gz",
        alleles_cstacks="results/lib2/stacks_denovo/cstacks/catalog.alleles.tsv.gz",
        list_cstacks="results/lib2/stacks_denovo/cstacks/catalog.sample_list.tsv.gz"
    resources:
        cpus=1,
        mem_mb=3740,
        time="00:30:00"
