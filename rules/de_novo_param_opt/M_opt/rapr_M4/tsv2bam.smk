...
rule tsv2bam:
    ...
    output:
        "results/de_novo_param_opt/M_opt/rapr_M4/stacks_denovo/{sample}.matches.bam"
    conda:
        "stacks2.68-3"
    threads: 8
    resources:
        ...
        time="1:00:00"
    log:
        "results/de_novo_param_opt/M_opt/rapr_M4/logs/stacks_denovo/tsv2bam/{sample}.log"
    benchmark:
        "results/de_novo_param_opt/M_opt/rapr_M4/benchmarks/stacks_denovo/tsv2bam/{sample}.bmk"
    shell:
        " (tsv2bam				"
