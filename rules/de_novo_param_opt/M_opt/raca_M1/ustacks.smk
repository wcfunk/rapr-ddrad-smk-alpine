...
rule ustacks:
    ...
    resources:
        ...
        time="24:00:00"
    log:
        "results/de_novo_param_opt/M_opt/raca_M1/logs/stacks_denovo/ustacks/{sample}.log"
    benchmark:
        "results/de_novo_param_opt/M_opt/raca_M1/benchmarks/stacks_denovo/ustacks/{sample}.bmk"
    shell:
        " (ustacks -f {input.R1}			"
        " -o results/de_novo_param_opt/M_opt/raca_M1/ustacks/		"
