...
rule gstacks:
    input:
        ...
        expand("results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/{s}.matches.tsv.gz", s=SAMPLES),
        expand("results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/{s}.matches.bam", s=SAMPLES)
    output:
        "results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/catalog.fa.gz",
        "results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/catalog.calls"
    conda:
        "stacks2.68-3"
    threads: 4
    resources:
        ...
        time="1:00:00"
    log:
        "results/de_novo_param_opt/M_opt/raau_M5/logs/stacks_denovo/gstacks/gstacks.log"
    benchmark:
        "results/de_novo_param_opt/M_opt/raau_M5/benchmarks/stacks_denovo/gstacks/gstacks.bmk"
    shell:
        " (gstacks				"
        " -P results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/	"
        " -O results/de_novo_param_opt/M_opt/raau_M5/stacks_denovo/	"
