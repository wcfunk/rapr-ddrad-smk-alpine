...
rule cstacks:
    ...
    resources:
        ...
        time="4:00:00"
    log:
        "results/de_novo_param_opt/M_opt/raca_M7/logs/stacks_denovo/cstacks/cstacks.log"
    benchmark:
        "results/de_novo_param_opt/M_opt/raca_M7/benchmarks/stacks_denovo/cstacks/cstacks.bmk"
    shell:
        " (cstacks				"
