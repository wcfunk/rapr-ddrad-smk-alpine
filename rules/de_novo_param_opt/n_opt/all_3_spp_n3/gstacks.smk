...
rule gstacks:
    input:
        ...
        expand("results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/{s}.matches.tsv.gz", s=SAMPLES),
        expand("results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/{s}.matches.bam", s=SAMPLES)
    output:
        "results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/catalog.fa.gz",
        "results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/catalog.calls"
    conda:
        "stacks2.68-3"
    threads: 12
    resources:
        ...
        time="12:00:00"
    log:
        "results/de_novo_param_opt/n_opt/all_3_spp_n3/logs/stacks_denovo/gstacks/gstacks.log"
    benchmark:
        "results/de_novo_param_opt/n_opt/all_3_spp_n3/benchmarks/stacks_denovo/gstacks/gstacks.bmk"
    shell:
        " (gstacks				"
        " -P results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/	"
        " -O results/de_novo_param_opt/n_opt/all_3_spp_n3/stacks_denovo/	"
