...
rule populations:
    ...
    output:
        "results/de_novo_param_opt/n_opt/rapr_n2/populations/populations.snps.vcf"
    threads: 12
    resources:
        mem_mb=44880,
        time="12:00:00"
    conda:
        "stacks2.68-3"
    log:
        "results/de_novo_param_opt/n_opt/rapr_n2/logs/populations/populations.log"
    benchmark:
        "results/de_novo_param_opt/n_opt/rapr_n2/benchmarks/populations/populations.bmk"
    shell:
        " (populations				"
        " -P results/de_novo_param_opt/n_opt/rapr_n2/stacks_denovo/ 	"
        " -O results/de_novo_param_opt/n_opt/rapr_n2/populations/ 		"
