...
rule sstacks:
    input:
        "results/de_novo_param_opt/n_opt/rapr_n2/stacks_denovo/{sample}.tags.tsv.gz",
        "results/de_novo_param_opt/n_opt/rapr_n2/stacks_denovo/{sample}.snps.tsv.gz",
        "results/de_novo_param_opt/n_opt/rapr_n2/stacks_denovo/{sample}.alleles.tsv.gz",
    ...
    resources:
        ...
        time="4:00:00"
    log:
        "results/de_novo_param_opt/n_opt/rapr_n2/logs/stacks_denovo/sstacks/{sample}.log"
    benchmark:
        "results/de_novo_param_opt/n_opt/rapr_n2/benchmarks/stacks_denovo/sstacks/{sample}.bmk"
    shell:
        " (sstacks				"
