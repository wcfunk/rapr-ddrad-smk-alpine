...
rule ustacks:
    ...
    output:
        tags="results/lib3/stacks_denovo/ustacks/{sample}.1.tags.tsv.gz",	
        snps="results/lib3/stacks_denovo/ustacks/{sample}.1.snps.tsv.gz",
        alleles="results/lib3/stacks_denovo/ustacks/{sample}.1.alleles.tsv.gz"
    conda:
        "stacks-2.65"
    resources:
        cpus=24,
